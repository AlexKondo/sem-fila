...
import { QrCode, ShoppingBag, Clock, ScanLine, Check } from 'lucide-react';

export default function LandingPage() {
  return (
    <main className="min-h-screen" style={{ backgroundColor: '#f8f6f6' }}>
      {/* Header — só logo, zero distração */}
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100 px-6 py-3 flex items-center justify-center">
      ...
      <section className="px-6 py-12 border-t border-slate-200">
        <div className="max-w-sm mx-auto text-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link
              href="/login-user"
              className="w-full h-12 font-semibold rounded-xl flex items-center justify-center gap-2 transition-all border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 transition-colors active:scale-95"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
